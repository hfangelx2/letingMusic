...
- (void)viewDidLoad {
    ...
    if (!self.enterButton) {
        ...
        [self.enterButton setTitle:NSLocalizedString(@"开启乐听音乐之旅", nil) forState:UIControlStateNormal];
        [self.enterButton setTitleColor:[UIColor colorWithRed:50.0/255 green:69.0/255 blue:109.0/255 alpha:1] forState:UIControlStateNormal];
        self.enterButton.layer.borderWidth = 0.5;
        self.enterButton.layer.borderColor = [UIColor colorWithRed:50.0/255 green:69.0/255 blue:109.0/255 alpha:1].CGColor;
    }
