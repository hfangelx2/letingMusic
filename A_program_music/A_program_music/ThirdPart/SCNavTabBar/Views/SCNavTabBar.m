...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    {
        /*//根据title长度 决定button长度
        CGSize size = [title sizeWithFont:[UIFont systemFontOfSize:[UIFont systemFontSize]]];
        CGSize MechineSixe = [UIScreen mainScreen].bounds.size;
        CGFloat width1 = 0;
         */
#pragma mark - 修改bar上的4个button间距!!!
        //NSNumber *width = [NSNumber numberWithFloat:size.width + width1];
